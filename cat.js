...
(function() {
  var Command, RoomHelper, User, addCommand, afksCommand, allAfksCommand, announceCurate, antispam, apiHooks, avgVoteRatioCommand, chatCommandDispatcher, chatUniversals, cmds, cookieCommand, data, dieCommand, disconnectLookupCommand, fans, handleNewSong, handleUserJoin, handleUserLeave, handleVote, hook, infoCommand, initEnvironment, initHooks, initialize, lockCommand, lockskipCommand, mcCommand, msToStr, newSongsCommand, newsCommand, opsongCommand, populateUserData, promoCommand, punishCommand, pupOnline, reloadCommand, removeCommand, roomHelpCommand, rulesCommand, settings, skipCommand, staffCommand, statusCommand, swapCommand, themeCommand, undoHooks, unhook, unlockCommand, updateVotes, versionCommand, voteRatioCommand, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref22, _ref23, _ref24, _ref25, _ref26, _ref27, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
    ...
    settings.prototype.songIntervalMessages = [
      {
        ...
        interval: 10,
        offset: 0,
        msg: "please do not play overplayed songs. a guideline list can be found at: http://goo.gl/mFoJC"
      }
    ];
  ...
  themeCommand = (function(_super) {
    ...
    themeCommand.prototype.functionality = function() {
      ...
      msg = "Any type of Electronic Dance Music is allowed here. Including Dubstep, Complextro, Drum and Bass, Glitch-Hop, Trap, ";
  ...
  mcCommand = (function(_super) {
    __extends(mcCommand, _super);

    function mcCommand() {
      _ref4 = mcCommand.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
    ...
    mcCommand.prototype.functionality = function() {
      return API.sendChat("The tastycat minecraft server is located at: play.tastycatmc.co.uk");
    };
  ...
  afksCommand = (function(_super) {
    ...
    function afksCommand() {
      _ref6 = afksCommand.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
  ...
  allAfksCommand = (function(_super) {
    ...
    function allAfksCommand() {
      _ref7 = allAfksCommand.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
  ...
  statusCommand = (function(_super) {
    ...
    function statusCommand() {
      _ref8 = statusCommand.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
  ...
  dieCommand = (function(_super) {
    ...
    function dieCommand() {
      _ref9 = dieCommand.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
  ...
  reloadCommand = (function(_super) {
    ...
    function reloadCommand() {
      _ref10 = reloadCommand.__super__.constructor.apply(this, arguments);
      return _ref10;
    }
  ...
  lockCommand = (function(_super) {
    ...
    function lockCommand() {
      _ref11 = lockCommand.__super__.constructor.apply(this, arguments);
      return _ref11;
    }
  ...
  unlockCommand = (function(_super) {
    ...
    function unlockCommand() {
      _ref12 = unlockCommand.__super__.constructor.apply(this, arguments);
      return _ref12;
    }
  ...
  removeCommand = (function(_super) {
    ...
    function removeCommand() {
      _ref13 = removeCommand.__super__.constructor.apply(this, arguments);
      return _ref13;
    }
  ...
  opsongCommand = (function(_super) {
    __extends(opsongCommand, _super);

    function opsongCommand() {
      _ref14 = opsongCommand.__super__.constructor.apply(this, arguments);
      return _ref14;
    }
    ...
    opsongCommand.prototype.functionality = function() {
      var msg;
  ...
  addCommand = (function(_super) {
    ...
    function addCommand() {
      _ref15 = addCommand.__super__.constructor.apply(this, arguments);
      return _ref15;
    }
  ...
  swapCommand = (function(_super) {
    ...
    function swapCommand() {
      _ref16 = swapCommand.__super__.constructor.apply(this, arguments);
      return _ref16;
    }
  ...
  skipCommand = (function(_super) {
    ...
    function skipCommand() {
      _ref17 = skipCommand.__super__.constructor.apply(this, arguments);
      return _ref17;
    }
  ...
  disconnectLookupCommand = (function(_super) {
    ...
    function disconnectLookupCommand() {
      _ref18 = disconnectLookupCommand.__super__.constructor.apply(this, arguments);
      return _ref18;
    }
    ...
    disconnectLookupCommand.prototype.functionality = function() {
      var cmd, dcHour, dcLookupId, dcMeridian, dcMins, dcSongsAgo, dcTimeStr, dcUser, disconnectInstances, givenName, id, recentDisconnect, resp, u, _i, _len, _ref19, _ref20;
  ...
  cookieCommand = (function(_super) {
    ...
    function cookieCommand() {
      _ref20 = cookieCommand.__super__.constructor.apply(this, arguments);
      return _ref20;
    }
  ...
  infoCommand = (function(_super) {
    __extends(infoCommand, _super);

    function infoCommand() {
      _ref21 = infoCommand.__super__.constructor.apply(this, arguments);
      return _ref21;
    }
    ...
    infoCommand.prototype.functionality = function() {
      var msg;

      msg = "You can find information about our room at: http://tastycatmc.co.uk/plugrules.html";
      return API.sendChat(msg);
    };
  ...
  avgVoteRatioCommand = (function(_super) {
    ...
    function avgVoteRatioCommand() {
      _ref22 = avgVoteRatioCommand.__super__.constructor.apply(this, arguments);
      return _ref22;
    }
    ...
    avgVoteRatioCommand.prototype.functionality = function() {
      var averageRatio, msg, r, ratio, roomRatios, uid, user, userRatio, votes, _i, _len, _ref23;
  ...
  staffCommand = (function(_super) {
    ...
    function staffCommand() {
      _ref23 = staffCommand.__super__.constructor.apply(this, arguments);
      return _ref23;
    }
  ...
  promoCommand = (function(_super) {
    ...
    function promoCommand() {
      _ref25 = promoCommand.__super__.constructor.apply(this, arguments);
      return _ref25;
    }
  ...
  versionCommand = (function(_super) {
    ...
    function versionCommand() {
      _ref26 = versionCommand.__super__.constructor.apply(this, arguments);
      return _ref26;
    }
  ...
  punishCommand = (function(_super) {
    ...
    function punishCommand() {
      _ref27 = punishCommand.__super__.constructor.apply(this, arguments);
      return _ref27;
    }
    ...
    punishCommand.prototype.getPunishment = function(username) {
      ...
      punishments = ["rubs sandpaper on @{victim}'s scrotum", "pokes @{victim} in the eyes", "throws sand in @{victim}'s eyes", "makes @{victim}'s mother cry", "penetrates @{victim} with a sharpie", "pinches @{victim}'s nipples super hard", "gives @{victim} a wet willy", "waterboards @{victim}", "puts @{victim} in the naughty corner", "orders @{victim} to clean the Latrines", "attatches jumper leads to @{victim}'s scrotum, piss me off anymore and i'll attatch it to the car battery", "sends @{victim} to guantanamo bay", "rapes @{victim} with a 2 metre long pole (because fuck imperial)", "throws @{victim} in front of a train"];
    ...
    punishCommand.prototype.functionality = function() {
      ...
      if (msg.length > 8) {
        ...
        if (user === false) {
          ...
          if (user.owner) {
            return API.sendChat("NOPE, NOT HAPPENING");
          } else {
  ...
  cmds = [newSongsCommand, themeCommand, rulesCommand, roomHelpCommand, afksCommand, allAfksCommand, statusCommand, dieCommand, reloadCommand, lockCommand, unlockCommand, removeCommand, addCommand, skipCommand, disconnectLookupCommand, infoCommand, mcCommand, voteRatioCommand, avgVoteRatioCommand, staffCommand, cookieCommand, opsongCommand, swapCommand, lockskipCommand, versionCommand, newsCommand, promoCommand];
  ...
  handleUserLeave = function(user) {
    var disconnectStats, i, u, _i, _len, _ref28;
  ...
  fans = function(chat) {
    ...
    if (msg.indexOf('fan me') !== -1 || msg.indexOf('reciprocate') !== -1 || msg.indexOf('f4n') !== -1 || msg.indexOf('fan4fan') !== -1 || msg.indexOf('fan 4 fan') !== -1 || msg.indexOf('fan 2 fan') !== -1 || msg.indexOf('add me to fan') !== -1 || msg.indexOf('adf.ly') !== -1) {
      API.moderateDeleteChat(chat.chatID);
      return API.sendChat("HOW ABOUT NO!?");
    }
  };
