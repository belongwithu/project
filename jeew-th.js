...
(function() {
  ...
  settings = (function() {
    ...
    settings.prototype.afkTime =  999 * 100 * 12 * 4 * 7 * 24 * 60 * 60 * 1000;
...
//    return API.sendChat("@" + user.username + " welcome to this room!");
  ...
  beggar = function(chat) {
    ...
    r = Math.floor(Math.random() * responses.length);
    if (msg.indexOf('fan me') !== -1 || msg.indexOf('fun me') !== -1 || msg.indexOf('become my fan') !== -1 || msg.indexOf('troco fa') !== -1 || msg.indexOf('fan for fan') !== -1 || msg.indexOf('fan 4 fan') !== -1 || msg.indexOf('add me to fan') !== -1 || msg.indexOf('fan4fan') !== -1 || msg.indexOf('fun4fun') !== -1 || msg.indexOf('fun 4 fun') !== -1 || msg.indexOf('virem meu fa') !== -1 || msg.indexOf('is now your fan') !== -1 || msg.indexOf('reciprocate') !== -1 || msg.indexOf('fans me') !== -1 || msg.indexOf('give fan') !== -1 || msg.indexOf('fan plz') !== -1 || msg.indexOf('fan pls') !== -1 || msg.indexOf('pls fan') !== -1 || msg.indexOf('plz fan') !== -1 || msg.indexOf('become fan') !== -1 || msg.indexOf('trade fan') !== -1 || msg.indexOf('fan i fan') !== -1 || msg.indexOf('be my fan') !== -1 || msg.indexOf('is now you fan') !== -1 || msg.indexOf('f@n f0r f@n') !== -1 || msg.indexOf('fan f0r fan') !== -1 || msg.indexOf('fan f0r') !== -1 || msg.indexOf('f4n for') !== -1 || msg.indexOf('f0r fan') !== -1 || msg.indexOf('f0n f4r') !== -1 || msg.indexOf('f@n') !== -1 || msg.indexOf('f4n') !== -1 || msg.indexOf('me fan') !== -1 || msg.indexOf('fans') !== -1) {
      API.sendChat(responses[r].replace("{beggar}", chat.from));
      return API.moderateDeleteChat(chat.chatID);
    }
  };
